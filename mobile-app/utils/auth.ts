...
export const saveEmployeeId = async (employeeId: string) => {
  await SecureStore.setItemAsync(EMPLOYEE_ID_KEY, employeeId);
};
...
export const getEmployeeId = async () => SecureStore.getItemAsync(EMPLOYEE_ID_KEY);
